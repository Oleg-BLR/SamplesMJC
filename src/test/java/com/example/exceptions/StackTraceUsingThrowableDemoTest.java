...
import com.example.exceptions.StackTraceUsingThrowableDemo;
...
public class StackTraceUsingThrowableDemoTest {
    ...
    public void whenElementIsFecthedUsingThrowable_thenCorrectMethodAndClassIsReturned() {
        ...
        assertEquals("com.example.exceptions.StackTraceUsingThrowableDemo", elementZero.getClassName());
        assertEquals("methodB", elementZero.getMethodName());

        StackTraceElement elementOne = stackTrace[1];
        assertEquals("com.example.exceptions.StackTraceUsingThrowableDemo", elementOne.getClassName());
