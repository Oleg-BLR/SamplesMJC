package com.example.streamsAndcollectors;
...
// 6. Collectors.joining() Example
        String csv = numbers.stream().map(String::valueOf)
...
//        Read more: https://www.java67.com/2018/11/10-examples-of-collectors-in-java-8.html#ixzz7sXwvS85n
